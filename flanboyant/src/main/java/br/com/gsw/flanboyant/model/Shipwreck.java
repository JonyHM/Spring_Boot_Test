package br.com.gsw.flanboyant.model;
...
@Entity //Relaciona a classe com JPA
public class Shipwreck {
	
	@Id //identifica a chave primária
	@GeneratedValue(strategy=GenerationType.AUTO)//como os valores da chave serão gerados
	Long id;
	String name;
	String description;
	String condition;
